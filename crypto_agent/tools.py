...
class SmartConsensusAnalyzer:
    ...
    def analyze(self, symbol: str, timeframe: str) -> Dict:
        ...
        self.logger.info(f"🐛 DEBUG: Predictions shape: {predictions.shape}")
        ...
        logger.info(f"✅ Consensus: {consensus['recommendation']} (confidence: {consensus['confidence']:.2%})")
...
class MarketContextAnalyzer:
    ...
    def analyze(self, symbol: str = 'BTC/USDT') -> Dict:
        ...
        logger.info(f"✅ Market Regime: {regime['type']} (confidence: {regime['confidence']:.0%})")
...
class PredictionOutcomeTracker:
    ...
    def log_recommendation(self, symbol: str, timeframe: str,
        ...
        if success:
            logger.info(f"💾 Logged recommendation: {symbol} {timeframe} - {recommendation}")
    ...
    def get_performance_stats(self, symbol: Optional[str] = None,
        ...
        if historical.empty:
            logger.info(f"ℹ️ No historical recommendations found for analysis")
            return {
